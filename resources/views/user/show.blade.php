    ...
    <div class="container mb-5">
       ...
       <div class="row bg-white mt-4 pt-3 p-1 rounded-3 shadow-sm">
          <div class="d-flex justify-content-between">
            ...
            <div>
               <a href="/user/{{ $user->username }}/edit" class="btn btn-warning"><i class="bi bi-pencil"> Edit</i></a>
         ...
         <div class="text-center">
           @if ($user->image)
            <img src="{{ asset('/storage/'.$user->image) }}" alt="Foto Profil {{ $user->name }}" width="170">
           @else
