    ...
    <div class="container">
       ...
       <div class="row bg-white mt-4 pt-3 p-1 rounded-3 shadow-sm">
        <form action="/surat-keluar" method="POST" enctype="multipart/form-data">
          ...
          {{-- <div class="mb-3">
           <label for="komentar" class="form-label"><i class="bi bi-file-earmark-font"></i> Komentar</label>
           <input type="text" class="form-control @error('komentar') is-invalid @enderror" id="komentar" name="komentar" value="{{ old('komentar') }}" required>
           @error('komentar')
               <div class="invalid-feedback">
                 {{ $message }}
               </div>
         ...
         <div class="mb-3">
          ...
          <textarea class="form-control @error('isi') is-invalid @enderror" name="isi" id="surat_keluar" rows="3" required>{{ old('isi') }}</textarea>
         ...
         <div class="mb-3">
          ...
          <input class="form-control @error('berkas') is-invalid @enderror" type="file" id="berkas" name="berkas" require>
          @error('berkas')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
