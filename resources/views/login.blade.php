  ...
  <body style="background-color: #4FCAE4">
     <div class="container mt-4">
        <div class="row d-flex justify-content-center">
           ...
           <div class="col-lg-8 w-50 text-center bg-white m-5 p-5 rounded-3" style="box-shadow: 20px 20px 30px rgba(0,0,0,0.5)">
              <img src="{{ asset('img/himmi.png') }}" alt="" class="w-25 mb-3">
              <h3>Sistem Informasi Manajemen Admnistriasi</h3>
